 ...
 */
// Standalone launch scope set. Works against launch.smarthealthit.org.
// Epic's sandbox rejects standalone for apps registered under CMS Prior
// Auth use case (Epic's CMS Prior Auth is intended for backend CRD/DTR/PAS
// flows, not self-serve standalone reads), so this scope set is not what
// gates Epic — Epic strips all resource scopes for our registered app
