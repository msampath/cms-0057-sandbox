 ...
 */
// Standalone launch scopes. Epic accepts patient/*.read scopes on
// General-use-case apps but rejects `launch/patient` as an unknown scope
// — Epic's standalone flow selects the patient via its own login UI, no
// scope declaration required. SMART App Launcher accepts both patterns.
