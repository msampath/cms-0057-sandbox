 ...
 */
// Epic's standalone flow accepts `openid fhirUser` plus the resource-level
// scopes needed. It does NOT accept `launch/patient` here even though the
// SMART spec allows it, because Epic's standalone patient picker is
// bound to the FHIR resource scopes rather than a launch-context scope.
// Keep the scope list minimal to whatever the Epic app registration has
// APIs enabled for: Patient.Read, Coverage.Read, Encounter.Read.
