...
export function buildSeedEntries(db) {
  ...
  {
    const patientId = 'pat-6614-marcus-johnson';
  ...
  {
    const patientId = 'pat-3301-dorothy-hayes';
    const npi = 'GOLD-NPI-0001';
    const code = '27447';
  ...
  {
    const patientId = 'pat-8849-jane-doe';
    const coverageId = 'cov-comm-ppo-bcbsil';
    const npi = '1234567890';
    const code = '70553';
    const rule = findCodeRule(db, code);
    const patient = {
